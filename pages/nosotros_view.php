...
<section class="page-section">
    <div class="container px-4 px-lg-5">
        ...
        <div class="row mb-5">
            <div class="col-lg-3 col-md-6 text-center" data-aos="fade-down" data-aos-duration="800" data-aos-delay="0">
                <div class="mt-5">
            ...
            <div class="col-lg-3 col-md-6 text-center" data-aos="fade-down" data-aos-duration="800" data-aos-delay="200">
                <div class="mt-5">
            ...
            <div class="col-lg-3 col-md-6 text-center" data-aos="fade-down" data-aos-duration="800" data-aos-delay="400">
                <div class="mt-5">
            ...
            <div class="col-lg-3 col-md-6 text-center" data-aos="fade-down" data-aos-duration="800" data-aos-delay="600">
                <div class="mt-5">
