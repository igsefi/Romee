            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#contact">Clientes</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">QUIENES SOMOS?</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Romee Solución Industrial es una empresa dedicada a brindar soluciones de alta
                            calidad en montaje industrial, soldaduras sanitarias y fabricación de estructuras
                            en acero inoxidable, para industrias con altos estándares como alimenticia,
                            farmacéutica, cervecerías y biotecnología.
                            En el transcurso de nuestra trayectoria acompañamos a empresas lideres,
                            cumpliendo con las normas sanitarias y de seguridad más exigentes.</p>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0">Nuestros servicios</h2>
                        <hr class="divider divider-light" />
                        <p class="text-white-75 mb-4">• Montajes de cañerías en acero inoxidable • Sanitarias certificadas • Construcción de estructuras y soportes • Instalaciones para líneas de procesos                  •Servicios de mantenimiento y modificación
                            • Normativas: Cumplimos con normativas GMP, IRAM, y estándares de calidad alimentaria y farmacéutica.</p>
